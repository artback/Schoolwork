...
int main() {
  Carregister myCars(SIZEOFARR);
    bool loop = true;
     //readFromFile(myCars);
    myCars.addCar("vovlo","tsd547",1000,1000);
    myCars.addCar("ferrari","tsv431",100,100000);
    printArrOfStrings(myCars);
    myCars.addCar("bil3","tyr541",1000,1000);
    myCars.removeCar("rrr555");
    printArrOfStrings(myCars);
    myCars.removeCar("tsd547");
    myCars.removeCar("tsv431");
    myCars.removeCar("tyr541");
    myCars.removeCar("rrr555");
    myCars.addCar("bil4","tgr551",1000,1000);
    myCars.addCar("bil5","ttr551",1000,1000);
    Carregister newcars = myCars;
    printArrOfStrings(newcars);
    Carregister newC(myCars);
    printArrOfStrings(newC);
