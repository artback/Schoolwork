...
import se.bthstudent.android.bsk.rssreader.NewsListAdapter;
import se.bthstudent.android.bsk.rssreader.RSSHandler;
...
public class NewsActivity extends ListActivity implements BSKLOG {
	...
	public class FetchNews extends AsyncTask<String, Integer, Boolean> implements BSKLOG {
		...
		protected void onPreExecute() {
			...
			progressDialog.setMessage(NewsActivity.this.getString(R.string.fetch_news));
